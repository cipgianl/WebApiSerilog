...
namespace LoggingLibrary.Sqlite
{
    public static class LoggerConfigurationSqliteExtensions
    {
        public static LoggerConfiguration Sqlite(this LoggerSinkConfiguration sinkConfiguration,
            string databasePath, string tableName, IConfiguration configuration, LogEventLevel restrictedToMinimumLevet = LevelAlias.Minimum,
            LoggingLevelSwitch levelSwitch = null)
        {
            ...
            return sinkConfiguration.Sink(new SqliteSink(sqliteDbFile.FullName, tableName), restrictedToMinimumLevet, levelSwitch);
        }
